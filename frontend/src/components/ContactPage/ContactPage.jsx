  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: [
        ...
        "admin@jimmazone.gov.et",
        "services@jimmazone.gov.et",
      ],
                ...
                <div className="h-64 bg-gradient-to-r from-[#F5F4FF] to-[#E5E4FF] relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-4">
                      ...
                      <p className="text-gray-600">
                        Jimma City, Oromia Region, Ethiopia
                      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                answer:
                  "We welcome feedback through our online form, via email at feedback@jimmazone.gov.et, or in person at our office.",
              },
            ].map((faq, index) => (
              <div
                key={index}
