...
const HistoryPage = () => {
  ...
  const quickStats = [
    { number: "190,444", label: "Total Population", icon: Users },
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F5F4FF] to-white">
      ...
      <section className="relative py-20 bg-gradient-to-r from-[#21203C] to-[#2D2B4A] text-white overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1544525977-1b4d2a3aab71?auto=format&fit=crop&w=1200&q=80)",
          }}
        ></div>
